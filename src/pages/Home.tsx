        ...
        <>
            ...
            <ContentSection>
                <article>
                    ...
                    <p className='mt-5'>
                        Tu as 5 quizs en accès libre pour te permettre de découvrir
                        le contenu. Cependant ton score ne sera pas enregistré et au
                        bout des 5 essais, tu n'auras malheureusement plus accès au
                        contenu.
                        <br /> Si tu veux pouvoir le sauvegarder et continuer à
                        jouer, tu dois créer un compte <span className="font-bold text-green-500">gratuitement</span>.
                    </p>
